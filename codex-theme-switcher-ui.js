...
#${PANEL_ID} .theme-item.is-preview {
  ...
  background: color-mix(in oklab, var(--vscode-focusBorder, #8aadf4) 24%, transparent);
}
...
#${PANEL_ID} .preview-btn.primary {
  border-color: color-mix(in oklab, var(--color-token-accent, #8aadf4) 45%, transparent);
  background: color-mix(in oklab, var(--color-token-accent, #8aadf4) 20%, transparent);
}
            ...
            <section class="right-pane">
              ...
              <div class="preview-cards">
                <article class="preview-card">
                  ...
                  <div class="inline-pill">RUN_ID=preview-2026-02-12</div>
                </article>
                <article class="preview-card">
                ...
                <article class="preview-card">
                  ...
                  <div class="preview-diff">
                    <div class="preview-diff-line add"><span class="ln">1</span><span>+</span><span>S3_PREFIX=raw/upwage.com</span></div>
                    <div class="preview-diff-line plain"><span class="ln">2</span><span> </span><span>MAX_PAGES=500</span></div>
                    <div class="preview-diff-line remove"><span class="ln">3</span><span>-</span><span>OLD_PREFIX=legacy</span></div>
                  </div>
                </article>
                <article class="preview-card">
                  <div class="preview-card-title">Terminal</div>
                  <pre class="preview-terminal"><span class="prompt">$</span> docker run scraper
<span class="ok">upload complete:</span> pages.jsonl.gz + manifest.json</pre>
                </article>
              </div>
              <div class="actions">
